...
public class TestYourController extends SimpleModel implements IView
{
	...
	public void createTestButtons()
	{
		...
		JButton button9a = new JButton("Random fill so current player can still play (draw, 32 pieces each)");
		...
		JButton button10a = new JButton("Altenate colours, resulting in a draw!");
